...
public interface OvenPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default void setTemperature(int temp)
        throws WrongTemperaturevaluesException
    {
        setTemperature(temp, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void setTemperature(int temp, java.util.Map<String, String> context)
        throws WrongTemperaturevaluesException
    {
        try
        {
        ...
        catch(WrongTemperaturevaluesException ex)
        {
            throw ex;
        }
    ...
    default java.util.concurrent.CompletableFuture<Void> setTemperatureAsync(int temp)
    {
        return _iceI_setTemperatureAsync(temp, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> setTemperatureAsync(int temp, java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_setTemperatureAsync(int iceP_temp, java.util.Map<String, String> context, boolean sync)
    {
    ...
    {
        WrongTemperaturevaluesException.class
    };
        ...
        throws ChangeStateException
    {
        try
        {
            _iceI_changeStateAsync(context, true).waitForResponseOrUserEx();
        }
    ...
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "changeState", com.zeroc.Ice.OperationMode.Idempotent, sync, _iceE_changeState);
        f.invoke(true, context, null, null, null);
        return f;
    }

    /** @hidden */
    static final Class<?>[] _iceE_changeState =
    {
        ChangeStateException.class
    };
